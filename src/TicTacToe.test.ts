...
describe("Tic Tac Toe", () => {
  ...
  it("should win if 1st row is filled by same player", () => {
    ...
    expect(game.getResult()).toBe("Player O won!");
  });
  ...
  it("should win if 2nd row is filled by same player", () => {
    ...
    expect(game.getResult()).toBe("Player X won!");
  });
  ...
  it("should win if 1st diagonal is filled by same player", () => {
    ...
    game.makeMove(5);
    game.makeMove(8);
    expect(game.getCells()).toEqual(["O", "X", "X", "", "O", "X", "", "", "O"]);
    expect(game.getWinner()).toBe("O");
    expect(game.getResult()).toBe("Player O won!");
  });
  ...
  it("should end game with draw if no one wins", () => {
    ...
    expect(game.getDraw()).toBe("draw");
    expect(game.getResult()).toBe("It's a draw!");
  });
